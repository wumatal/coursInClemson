...
%type<node> comparison not_test and_test or_test test opt_test opt_yield_test testlist
%type<node> small_stmt expr_stmt print_stmt pick_yield_expr_testlist star_EQUAL
%type<node> pick_yield_expr_testlist_comp yield_expr testlist_comp comp_for
%token<id> NAME
