...
%type<node> atom power term factor expr xor_expr and_expr shift_expr arith_expr
%type<node> comparison not_test and_test or_test opt_IF_ELSE test small_stmt
%type<node> expr_stmt pick_yield_expr_testlist star_EQUAL print_stmt opt_test
...
%type<node> star_trailer trailer flow_stmt return_stmt argument pick_argument
...
%type<vec> plus_stmt varargslist star_fpdef_COMMA opt_arglist arglist star_argument_COMMA
	...
	| comparison comp_op expr
	  {
			switch($2) {
				case LESS:
					$$ = new LessThanBianryNode($1, $3);
					pool.add($$);
					break;
				case LESSEQUAL:
					$$ = new LessEqualBianryNode($1, $3);
					pool.add($$);
					break;
				case NOTEQUAL:
					$$ = new NotEqualBianryNode($1, $3);
					pool.add($$);
					break;
	      case EQEQUAL:
	        $$ = new EqualBianryNode($1, $3);
	        pool.add($$);
	        break;
	      case GREATER:
	        $$ = new GreatThanBianryNode($1, $3);
	        pool.add($$);
	        break;
	      case GREATEREQUAL:
	        $$ = new GreatEqualBianryNode($1, $3);
	        pool.add($$);
	        break;
	      case GRLT:
	        $$ = new NotEqualBianryNode($1, $3);
