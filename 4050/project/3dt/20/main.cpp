...
int main (int argc, char **argv) {
    ...
    glutGameModeString( "1024x768:64@60" ); //the settings for fullscreen mode
    glutEnterGameMode(); //set glut to fullscreen using thesettings in the line above
    init (); //call the init function
    glutDisplayFunc (display); //use the display function tdraw everything
    glutIdleFunc (display); //update any variables in displdisplay can be changed to anyhing, as long as you move the ariables to be updated, in this case, angle++;
