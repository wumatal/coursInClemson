  ...
  channels()
{
  ...
  sounds.push_back( Mix_LoadWAV("sound/player/die.wav") );
  sounds.push_back( Mix_LoadWAV("sound/player/jump.wav") );
  sounds.push_back( Mix_LoadWAV("sound/player/finalDie.wav") );
  sounds.push_back( Mix_LoadWAV("sound/player/hattack.wav") );
  sounds.push_back( Mix_LoadWAV("sound/player/lattack.wav") );
  sounds.push_back( Mix_LoadWAV("sound/shoot.wav") );
  sounds.push_back( Mix_LoadWAV("sound/enemy.wav") );
  sounds.push_back( Mix_LoadWAV("sound/defend.wav") );
  sounds.push_back( Mix_LoadWAV("sound/base/destroy.wav") );
  sounds.push_back( Mix_LoadWAV("sound/player/hurt.wav") );
